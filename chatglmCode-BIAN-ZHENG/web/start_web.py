...
tokenizer = AutoTokenizer.from_pretrained("THUDM/chatglm-6b", trust_remote_code=True, pre_seq_len=128)
...
demo.queue().launch(share=False, inbrowser=True, server_port=8081)
